...
prs <- fread('/mnt/ml4cvd/projects/skhurshid/accel_phewas/cox_data_inferred_cutoff.csv')
...
# Save out
write.csv(out,file='/mnt/ml4cvd/projects/skhurshid/accel_phewas/phecode_processed/cox_inferred_cutoff.csv',row.names=F)