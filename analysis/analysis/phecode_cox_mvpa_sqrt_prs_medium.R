...
prs <- fread('/mnt/ml4cvd/projects/skhurshid/accel_phewas/cox_data_sqrt_prs_medium.csv')
...
# Save out
write.csv(out,file='/mnt/ml4cvd/projects/skhurshid/accel_phewas/phecode_processed/cox_mvpa_sqrt_prs_medium.csv',row.names=F)