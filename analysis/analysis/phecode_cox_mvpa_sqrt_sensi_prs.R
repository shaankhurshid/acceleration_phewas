...
prs <- fread('/mnt/ml4cvd/projects/skhurshid/accel_phewas/cox_data_mvpa_sqrt_sensi_prs.csv')
...
# Save out
write.csv(out,file='/mnt/ml4cvd/projects/skhurshid/accel_phewas/phecode_processed/cox_mvpa_sqrt_sensi_prs.csv',row.names=F)