...
mvpa_bmi <- fread('~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_bmi_processed_fdr_old.csv')
...
## ALL
# Plot
pdf('~/Documents/MGH Research/accel_phewas/phecode_plots/effect_size_box_mvpa_bmi_old.pdf',pointsize=6,
    height=6,width=9)
par(oma=c(1,1,1,1))
