...
value_bmi <- fread('~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_sqrt_prs_processed_fdr_old.csv')
...
## ALL
# Plot
pdf('~/Documents/MGH Research/accel_phewas/phecode_plots/effect_size_box_mvpa_sqrt_prs_old.pdf',pointsize=6,
    height=6,width=9)
par(oma=c(1,1,1,1))
