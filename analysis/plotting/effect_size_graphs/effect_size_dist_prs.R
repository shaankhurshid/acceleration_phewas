...
value_bmi <- fread('~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_prs_processed_fdr.csv')
...
## ALL
# Plot
pdf('~/Documents/MGH Research/accel_phewas/phecode_plots/effect_size_box_prs.pdf',pointsize=6,
    height=5,width=6.8)
par(oma=c(1,1,1,1))
par(mar=c(12,4,2,8))
