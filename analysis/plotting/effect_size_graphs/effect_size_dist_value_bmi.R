...
value_bmi <- fread('~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_value_bmi_processed_fdr.csv')
...
## ALL
# Plot
pdf('~/Documents/MGH Research/accel_phewas/phecode_plots/effect_size_box_value_bmi.pdf',pointsize=6,
    height=6,width=9)
par(oma=c(1,1,1,1))
