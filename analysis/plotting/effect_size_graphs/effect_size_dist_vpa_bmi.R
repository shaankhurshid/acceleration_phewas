...
vpa_bmi <- fread('~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_vpa_bmi_processed_fdr_covar.csv')

# Get median HR for each group
vpa_bmi[,group_median_hr := lapply(.SD,median,na.rm=T),.SDcols='hr',by='category']
setkey(vpa_bmi,group_median_hr)

### BOX AND WHISKER PLOTS
## ALL
# Plot
pdf('~/Documents/MGH Research/accel_phewas/phecode_plots/effect_size_box_vpa_bmi.pdf',pointsize=6,
    height=6,width=9)
par(oma=c(1,1,1,1))
