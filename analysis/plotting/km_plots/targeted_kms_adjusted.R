...
eso <- read.table(file='/Volumes/medpop_afib/skhurshid/phenotypes/2020_06/phecode_tables/phecode_530.tab.tsv',sep='\t',header = TRUE); setDT(eso)
htn <- read.table(file='/Volumes/medpop_afib/skhurshid/phenotypes/2020_06/phecode_tables/phecode_401_1.tab.tsv',sep='\t',header = TRUE); setDT(htn)
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_copd_cutoff_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
...
axis(2,at=seq(0,0.015,0.003),las=2,cex.axis=1.5,labels=c("0 %","0.3 %",'0.6 %','0.9 %','1.2 %','1.5 %'))
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_copd_prs_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.015),xlim=c(0,10),
     col=c(col_corr[all_categories=='respiratory']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:10,cex.axis=1.5,labels=as.character(0:10))
axis(2,at=seq(0,0.015,0.003),las=2,cex.axis=1.5,labels=c("0 %","0.3 %",'0.6 %','0.9 %','1.2 %','1.5 %'))
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_pad_cutoff_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.02),xlim=c(0,5),
     col=c(col_corr[all_categories=='circulatory system']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:5,cex.axis=1.5,labels=as.character(0:5))
axis(2,at=seq(0,0.02,0.005),las=2,cex.axis=1.5,labels=c('0 %','0.5 %','1 %','1.5 %','2 %'))

mtext("Cumulative risk (%)",side=2,line=6,at=0.1,cex=1.5)
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.02*1.05,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_pad_prs_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.02),xlim=c(0,10),
     col=c(col_corr[all_categories=='circulatory system']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_dm_cutoff_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.10),xlim=c(0,5),
     col=c(col_corr[all_categories=='endocrine/metabolic']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:5,cex.axis=1.5,labels=as.character(0:5))
axis(2,at=seq(0,0.10,0.02),las=2,cex.axis=1.5,labels=c('0 %','2 %','4 %','6 %','8 %','10 %'))

mtext("Cumulative risk (%)",side=2,line=6,at=0.05,cex=1.5)
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.10*1.05,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_dm_prs_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.10),xlim=c(0,10),
     col=c(col_corr[all_categories=='endocrine/metabolic']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')
...
# Fit models for adjustment
# Relevel
mod_value <- coxph(Surv(time_to_liver,has_disease) ~ strata(guidelines) + age_accel + sex,data=liver_analysis_value)
mod_prs <- coxph(Surv(time_to_liver,has_disease) ~ strata(guidelines) + enroll_age + sex,data=liver_analysis_prs)

weights <- data.frame(guidelines = levels(liver_analysis_value$guidelines),
                      age_accel = rep(mean(liver_analysis_value$age_accel),2),
                      sex = rep('Male',2))
weights2 <- data.frame(guidelines = levels(liver_analysis_prs$guidelines),
                       enroll_age = rep(mean(liver_analysis_prs$enroll_age),2),
                       sex = rep('Male',2))

# Plot
fit <- survfit(mod_value,newdata=weights)

CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_liver_cutoff_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.015),xlim=c(0,10),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_liver_prs_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.015),xlim=c(0,10),
     col=c(col_corr[all_categories=='digestive']$cat_col,'#8dd3c7'),lwd=1.5,
