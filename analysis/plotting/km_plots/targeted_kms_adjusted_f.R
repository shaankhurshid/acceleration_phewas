...
plot(fit,fun=function(x) 1-x,ylim=c(0,0.004),xlim=c(0,5),
     col=c(col_corr[all_categories=='respiratory']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:5,cex.axis=1.5,labels=as.character(0:5))
axis(2,at=seq(0,0.004,0.001),las=2,cex.axis=1.5,labels=c("0 %","0.1 %",'0.2 %','0.3 %','0.4 %'))

mtext("Cumulative risk (%)",side=2,line=6,at=0.002,cex=1.5)
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.004,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_copd_prs_adjusted_f.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.01),xlim=c(0,10),
     col=c(col_corr[all_categories=='respiratory']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:10,cex.axis=1.5,labels=as.character(0:10))
axis(2,at=seq(0,0.01,0.002),las=2,cex.axis=1.5,labels=c("0 %","0.2 %",'0.4 %','0.6 %','0.8 %','1 %'))

mtext("Cumulative risk (%)",side=2,line=6,at=0.005,cex=1.5)
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.01,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
       col=c(col_corr[all_categories=='respiratory']$cat_col,'#8dd3c7'),lty=1,lwd=1.5,bty='n',cex=1.5)
dev.off()
...
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.008,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
...
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.015,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
       col=c(col_corr[all_categories=='circulatory system']$cat_col,'#8dd3c7'),lty=1,lwd=1.5,bty='n',cex=1.5)
dev.off()
...
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.03,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_dm_prs_adjusted_f.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.07),xlim=c(0,10),
     col=c(col_corr[all_categories=='endocrine/metabolic']$cat_col,'#8dd3c7'),lwd=1.5,
     bty='n',xaxt='n',yaxt='n',xlab='',ylab='')

axis(1,at=0:10,cex.axis=1.5,labels=as.character(0:10))
axis(2,at=seq(0,0.07,0.01),las=2,cex.axis=1.5,labels=c('0 %','1 %','2 %','3 %','4 %','5 %','6 %','7 %'))

mtext("Cumulative risk (%)",side=2,line=6,at=0.035,cex=1.5)
mtext("Years",side=1, line=2.5,cex=1.5)
legend(-0.1,0.07,legend=c("Not Meeting Guidelines","Meeting Guidelines"),
       col=c(col_corr[all_categories=='endocrine/metabolic']$cat_col,'#8dd3c7'),lty=1,lwd=1.5,bty='n',cex=1.5)
dev.off()
