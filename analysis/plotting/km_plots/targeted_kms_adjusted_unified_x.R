...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_gastritis_cutoff_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.04),xlim=c(0,5),
...
CairoPDF(file='~/Documents/MGH Research/accel_phewas/km_gastritis_prs_adjusted.pdf',height=3,width=3.5,
         pointsize=6)
par(oma=c(3,4,1,1),mar=c(3,4,1,1))
plot(fit,fun=function(x) 1-x,ylim=c(0,0.04),xlim=c(0,5),
     col=c(col_corr[all_categories=='digestive']$cat_col,'#8dd3c7'),lwd=1.5,
