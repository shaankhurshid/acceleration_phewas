...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_mvpa_cutoff75_effect_fdr.pdf',height=7,width=10,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_cutoff75_bmi_processed_fdr.csv')
