...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_bmi_young_covar.csv')
...
# E-values
results[,rare_dz := ifelse(n_events/20505 <= 0.15,1,0)]
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_mvpa_bmi_fdr_young.pdf',height=5,width=12,pointsize=5)
...
axis(2,cex.axis=2.4,at=seq(0,16,2),las=2,pos=-2.5)

mtext("-log(p)",2,line=2.5,cex=2.4)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_mvpa_effect_fdr_young.pdf',height=7,width=10,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_bmi_processed_fdr_young.csv')
