...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_sqrt_prs.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_mvpa_sqrt_prs_fdr_simple.pdf',height=5,width=12,pointsize=5)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_mvpa_sqrt_prs_effect_fdr.pdf',height=7,width=16,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_mvpa_sqrt_prs_processed_fdr.csv')
