...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_bmi.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_bmi_fdr.pdf',height=5,width=12,pointsize=5)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_effect_fdr.pdf',height=7,width=10,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_bmi_processed_fdr.csv')
