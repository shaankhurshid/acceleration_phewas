...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_mvpa_cutoff_bmi_covar.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_mvpa_cutoff_fdr_simple_covar.pdf',height=5,width=12,pointsize=5)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_mvpa_cutoff_effect_fdr_covar.pdf',height=13,width=16,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_mvpa_cutoff_processed_fdr_covar.csv')
