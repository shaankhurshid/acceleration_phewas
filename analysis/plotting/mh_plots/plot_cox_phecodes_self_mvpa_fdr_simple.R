...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_mvpa_bmi.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_mvpa_fdr_simple.pdf',height=5,width=12,pointsize=5)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_self_mvpa_effect_fdr.pdf',height=13,width=16,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_self_mvpa_processed_fdr.csv')
