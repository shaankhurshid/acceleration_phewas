...
results <- fread(file='~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_value_bmi_invnorm.csv')
...
# Plot p-values
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_value_bmi_invnorm_fdr.pdf',height=5,width=12,pointsize=5)
...
pdf(file='~/Documents/MGH Research/accel_phewas/phecode_plots/cox_value_bmi_invnorm_effect_fdr.pdf',height=5,width=20,pointsize=5)
...
write.csv(results,'~/Documents/MGH Research/accel_phewas/phecode_outputs/cox_value_bmi_invnorm_processed_fdr.csv')
