...
plot(x=x_coord,y=results$hr,col=results$col,log='y',
     bty='n',xaxt='n',yaxt='n',pch=19,xlim=c(0,max(x_coord)),
     ylim=c(0.2,1.2),xlab='',ylab='',cex=2.5)

axis(1,at=x_coord,cex.axis=2,labels=rep('',nrow(results)))
axis(2,cex.axis=2.2,at=seq(0.2,1.2,0.2),las=2,pos=0)
...
legend(x=30,y=0.26,legend=unique(results$category),col=unique(results$col),ncol=4,
...
plot(x=x_coord,y=results$hr,col=results$col,log='y',
     bty='n',xaxt='n',yaxt='n',pch=19,xlim=c(0,max(x_coord)),
     ylim=c(0.6,1.2),xlab='',ylab='',cex=2.5)

axis(1,at=x_coord,cex.axis=2,labels=rep('',nrow(results)))
axis(2,cex.axis=2.2,at=seq(0.6,1.2,0.2),las=2,pos=0)
...
legend(x=26,y=0.66,legend=unique(results$category),col=unique(results$col),ncol=4,
       bty='n',pch=19,cex=1.6)
