...
# Load pre-seed data
prs <- fread(file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/no_accel_inferred_cutoff_phenotype.csv')

# Merges
setkey(prs,sample_id); setkey(censor_data,sample_id)
censor_data[prs,':='(inferred_accel = i.inferred_cutoff, PC1 = i.PC1, PC2 = i.PC2, PC3 = i.PC3, PC4 = i.PC4, PC5 = i.PC5)]
...
# Write out
write.csv(prs,file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/cox_data_inferred_cutoff.csv',row.names = F)
