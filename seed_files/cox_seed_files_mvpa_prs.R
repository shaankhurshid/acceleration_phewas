...
# Load pre-seed data
prs <- fread(file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/no_accel_mvpa_prs_phenotype.csv')
...
# Write out
write.csv(prs,file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/cox_data_mvpa_prs.csv',row.names = F)
