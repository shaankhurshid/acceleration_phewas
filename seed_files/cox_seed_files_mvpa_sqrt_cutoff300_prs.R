...
censor_data[prs,':='(inferred_accel = i.inferred_300, PC1 = i.PC1, PC2 = i.PC2, PC3 = i.PC3, PC4 = i.PC4, PC5 = i.PC5)]
...
# Write out
write.csv(prs,file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/cox_data_mvpa_sqrt_cutoff300_prs.csv',row.names = F)
