...
# Re-standardize
prs <- prs[,inferred_accel := (inferred_accel - mean(inferred_accel))/sd(inferred_accel)]
  
# Write out
write.csv(prs,file='/Volumes/medpop_afib/skhurshid/acceleration_phewas/cox_data_mvpa_sqrt_sensi_prs.csv',row.names = F)
